...
<div className="hero-grid"><div className="hero-copy"><h1><span>Use AI to think</span><span>more clearly.</span><em><span>Build what</span><span>matters.</span></em></h1><p className="hero-description">I help founders and teams learn AI and build a business that needs less reminding, repeating, and chasing.</p><div className="hero-actions"><a className="button" href="#learn">Explore ways to work <ArrowDown size={18}/></a><a className="inline-link" href="/learn">Here to learn? <ArrowUpRight size={18}/></a></div></div>
