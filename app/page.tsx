...
<section className="changes section-pad" id="changes" data-reveal>
 ...
 <div className="change-grid">
  <article><span className="small-number">01</span><h3>Explaining your<br/>business. <em>Again.</em></h3><div className="change-outcome"><ArrowUpRight size={19}/><p>Reusable context. Clear instructions. A starting point that isn’t zero.</p></div><details className="familiar-detail"><summary>Sound familiar? <Plus size={16}/></summary><p>A new AI conversation. Another twenty minutes explaining what you do, who you work with, and why that draft sounds nothing like you.</p></details></article>
...
<section className="example-section section-pad" id="examples" data-reveal>
 ...
 <div className="example-intro"><div><h2>Change<br/><em>the record.</em></h2><p>Less theory. A small look at what can change when the work has somewhere to go.</p><span className="record-note">same you. a different way through.</span></div><figure className="record-photo"><img src="/studio-record.png" alt="Hands choosing a record on a vintage turntable" width="816" height="960" loading="lazy"/><figcaption>THE OLD ROUTINE ISN’T THE ONLY WAY.</figcaption></figure></div>
